...
# Ollama configuration for Qwen
OLLAMA_BASE_URL = "http://localhost:11434/v1"
OLLAMA_MODEL = "qwen2.5:7b-instruct"  # Using locally available model

# Set up Ollama client as default OpenAI client
...
async def locomo_response(group_id: int, query: str, users: list[str], model: str = None):
    """Answer a locomo benchmark question using an OpenAI Agents SDK agent."""
    # Use Ollama/Qwen by default
    if model is None or model == "gpt-4o-mini":
        model = OLLAMA_MODEL
