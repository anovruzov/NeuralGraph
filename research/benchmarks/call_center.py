...
BENCHMARK_PATH = Path(__file__).resolve().parents[1] / "datasets" / "call_center_benchmark.json"
OUTPUT_PATH = Path(__file__).resolve().parents[1] / "results" / "call_center_results.json"
